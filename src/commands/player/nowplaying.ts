...
export default {
    data: new SlashCommandBuilder().setName("nowplaying").setDescription("Ver información sobre la canción actual.").setDMPermission(false),
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        embed.setDescription(`${progress}\n\nEstá sonando una canción añadida por <@${queue.currentTrack.requestedBy.id}>.`);
